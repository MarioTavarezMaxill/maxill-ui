...
const GENERAL_RULES = {
	complexity: [RULES.ERROR, { max: 10 }],
	'no-console': RULES.ERROR,
	'func-names': RULES.ERROR,
	'no-var': RULES.ERROR,
	'max-params': [RULES.ERROR, { max: 3 }],
	...
	'max-statements': [RULES.ERROR, { max: 15 }],
	...
	'no-else-return': [RULES.ERROR, { allowElseIf: true }],
	'max-lines-per-function': [
		RULES.ERROR,
		{ max: 200, skipBlankLines: true, skipComments: true },
	],
	camelcase: [RULES.ERROR, { properties: 'always' }],
};
